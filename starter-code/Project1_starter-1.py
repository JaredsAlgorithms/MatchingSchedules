...
def updateSchedule(Schedule, DailyAct):
    ...
    # update unavailable schedules and add early morning hours
    updatedSchedule.insert(0, ['0:00', DailyAct[0]])
    # update unavailable schedules and add after work hours
    updatedSchedule.append([DailyAct[1], '23:59'])
...
def main():
    ...
    groupSchedule1 = groupschedule(
        pers1Schedule, pers1DailyAct, pers2Schedule, pers2DailyAct, duration)
